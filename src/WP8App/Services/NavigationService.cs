...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        private static readonly IDictionary<Type, string> ViewModelRouting = new Dictionary<Type, string>()
        {
            ...
            { typeof(IViewModels.ITheStory_InfoViewModel), "/View/TheStory_Info.xaml" },
            { typeof(IViewModels.Ipictures_NewsViewModel), "/View/pictures_News.xaml" },
            { typeof(IViewModels.Icharacters_ListViewModel), "/View/characters_List.xaml" },
            { typeof(IViewModels.Icharacters_DetailViewModel), "/View/characters_Detail.xaml" },
