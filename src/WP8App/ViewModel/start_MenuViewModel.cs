...
namespace WPAppStudio.ViewModel
{
    ...
    {       
        ...
        public start_MenuViewModel(IServices.IDialogService dialogService, IServices.INavigationService navigationService, IServices.ILockScreenService lockScreenService, IServices.IInternetService internetService)
        {
		...
		private Controls.MenuItemData _selectedMenuSection1_MenuMenuControl;

        /// <summary>
        /// SelectedMenuSection1_MenuMenuControl property.
        /// </summary>		
        public Controls.MenuItemData SelectedMenuSection1_MenuMenuControl
        {
            get
            {
				return _selectedMenuSection1_MenuMenuControl;
            }
            set
            {
                _selectedMenuSection1_MenuMenuControl = value;
                if (value != null)
                    _navigationService.NavigateTo(value);
            }
        }
