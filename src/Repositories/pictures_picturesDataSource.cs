...
namespace WPAppStudio.Repositories
{
    ...
    public class pictures_picturesDataSource : Ipictures_picturesDataSource 
    {
		...
		private const string RssUrl = "http://www.obsrv.com/General/ImageFeed.aspx?death+rides+a+horse";

        /// <summary>
        /// Initializes a new instance of the <see cref="pictures_picturesDataSource" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public pictures_picturesDataSource(RepositoriesBase.IXmlDataSource xmlDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://www.obsrv.com/General/ImageFeed.aspx?death+rides+a+horse), in an observable collection of RssSearchResult items.
        /// </summary>
        ...
        public async Task<ObservableCollection<EntitiesBase.RssSearchResult>> Refresh()
        {
            ...
            if (_internetService.IsNetworkAvailable())
            {
				...
				_storageService.Save("pictures_picturesDataSource", items);
				
				return items;
			}

			return _storageService.Load<ObservableCollection<EntitiesBase.RssSearchResult>>("pictures_picturesDataSource");
        }
						
		/// <summary>
        /// Retrieves the data from a RSS data source (http://www.obsrv.com/General/ImageFeed.aspx?death+rides+a+horse), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
